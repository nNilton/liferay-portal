 ...
 */
@Generated("")
@GraphQLName("SiteInstance")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "SiteInstance")
public class SiteInstance implements Serializable {

	public static SiteInstance toDTO(String json) {
		return ObjectMapperUtil.readValue(SiteInstance.class, json);
	}

	public static SiteInstance unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(SiteInstance.class, json);
	}

	@Schema(description = "Site's group")
	...
	@GraphQLField(description = "Site's group")
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.portal.instances.dto.v1_0.SiteInstance",
		name = "x-class-name"
	)
