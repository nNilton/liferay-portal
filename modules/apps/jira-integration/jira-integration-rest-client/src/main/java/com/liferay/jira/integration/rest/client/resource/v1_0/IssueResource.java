...
package com.liferay.jira.integration.rest.client.resource.v1_0;
...
import com.liferay.jira.integration.rest.client.problem.Problem;
...
public interface IssueResource {
	...
	public static class Builder {
		...
		public IssueResource build() {
			return new IssueResourceImpl(this);
		}
	...
	public static class IssueResourceImpl implements IssueResource {
		...
		public Issue getIssue(Long siteId, String issueId) throws Exception {
			...
			try {
				return IssueSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private IssueResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			IssueResource.class.getName());
