...
public class SiteInitializerExtension {
	...
	public SiteInitializerExtension(
		...
		SegmentsEntryLocalService segmentsEntryLocalService, SegmentsExperienceLocalService segmentsExperiencesLocalService,
		...
		BundleSiteInitializer bundleSiteInitializer = new BundleSiteInitializer(
			...
			roleLocalService, sapEntryLocalService, segmentsEntryLocalService, segmentsExperiencesLocalService,
