...
public class BaseAnalyticsDXPEntityBatchEngineTaskItemDelegateTest {
	...
	public void testReadIfAdministratorUser() throws Exception {
		_setContextUser(TestPropsValues.getUser());
	...
	private void _setContextUser(User user) {
		ReflectionTestUtil.setFieldValue(
			_batchEngineTaskItemDelegate, "contextUser", user);
	}
