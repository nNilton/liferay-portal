...
1.  Tag and publish the new release.
...
1.  Sanity check [the @liferay/stylelint-plugin page](https://www.npmjs.com/package/@liferay/stylelint-plugin) on npmjs.com
